 ...
 */
public class PostalCodeFacilitiesDao extends SqliteSyncEntityDao {
    public static final String TABLE_NAME = "POSTAL_CODE_FACILITIES";

    public static final String ENTITY_CLASS_NAME = PostalCodeFacilities.class.getName();

    public static final String CREATE_STATEMENT =
            "CREATE TABLE POSTAL_CODE_FACILITIES (" +
                    "ID TEXT PRIMARY KEY," +
                    "VERSION INTEGER," +
                    "SYNC_STATE INTEGER" +
                    ")";
    ...
    protected <T extends SyncEntity> T fromCursor(Cursor c) {
        return (T) new PostalCodeFacilities(
                getString(COL_ID, c),
